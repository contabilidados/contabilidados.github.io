...
1.  **Gráfico** se o parâmetro `relatorio` for `TRUE` ou `T`, mostra um
...
| `relatorio`       | Mostra gráfico? (TRUE/FALSE)                                                             |
...
pedir para apresentar o gráfico (`relatorio = F`). Como queremos usar apenas
